        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ active_menu('manufacturers')[0] }}">
                ...
                <ul class="treeview-menu" style="{{ active_menu('manufacturers')[1] }}">
                    <li class=""><a href="{{ aurl('manufacturers') }}"><i class="fa fa-user"></i>
                            {{ trans('admin.manufacturers') }}</a></li>
                    <li class=""><a href="{{ aurl('manufacturers/create') }}"><i class="fa fa-plus"></i>
                            {{ trans('admin.add') }}</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ active_menu('shipping')[0] }}">
                ...
                <ul class="treeview-menu" style="{{ active_menu('shipping')[1] }}">
                    <li class=""><a href="{{ aurl('shipping') }}"><i class="fa fa-truck"></i>
                            {{ trans('admin.shipping') }}</a></li>
                    <li class=""><a href="{{ aurl('shipping/create') }}"><i class="fa fa-plus"></i>
                            {{ trans('admin.add') }}</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ active_menu('malls')[0] }}">
                ...
                <ul class="treeview-menu" style="{{ active_menu('malls')[1] }}">
                    <li class=""><a href="{{ aurl('malls') }}"><i class="fa fa-building"></i>
                            {{ trans('admin.malls') }}</a></li>
                    <li class=""><a href="{{ aurl('malls/create') }}"><i class="fa fa-plus"></i>
                            {{ trans('admin.add') }}</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ active_menu('colors')[0] }}">
                ...
                <ul class="treeview-menu" style="{{ active_menu('colors')[1] }}">
                    <li class=""><a href="{{ aurl('colors') }}"><i class="fa fa-paint-brush"></i>
                            {{ trans('admin.colors') }}</a></li>
                    <li class=""><a href="{{ aurl('colors/create') }}"><i class="fa fa-plus"></i>
                            {{ trans('admin.add') }}</a></li>
                </ul>
            </li>
